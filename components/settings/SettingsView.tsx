        ...
        <div className="divide-y divide-white/[0.06]">
          ...
          <div className="py-3.5 space-y-3">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center bg-[#080C18]/90 border border-white/[0.14] rounded-xl p-1 shadow-inner focus-within:border-amber-400 focus-within:ring-2 focus-within:ring-amber-400/25 transition-all">
                  <button
                    type="button"
                    onClick={handleDecrementFocusGoal}
                    disabled={currentGoalHours <= 0.5}
                    aria-label="Decrease focus target"
                    className="w-7 h-7 rounded-lg bg-white/[0.04] hover:bg-amber-500/20 active:scale-90 disabled:opacity-25 disabled:pointer-events-none flex items-center justify-center text-slate-300 hover:text-amber-300 transition-all cursor-pointer"
                  >
                  ...
                  <input
                    ...
                    className="w-10 text-center text-xs font-mono font-bold text-white bg-transparent outline-none"
                    placeholder="4"
                  />
                  <button
                    type="button"
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              {focusGoalPresets.map((val) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl text-xs font-mono font-bold transition-all active:scale-90 cursor-pointer ${
                    currentGoalHours === val
                      ? 'bg-gradient-to-tr from-amber-600 via-amber-500 to-yellow-500 text-white shadow-[0_0_14px_rgba(245,158,11,0.6)] border border-amber-300/60 font-black'
            ...
            <input
              ...
              className="w-full cursor-pointer h-2 rounded-full appearance-none outline-none accent-amber-400 shadow-inner"
            />
          </div>
